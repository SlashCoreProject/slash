...
Only requiring some minor changes is slash.cpp.
...
Changes to slash.cpp
----------------------
slash.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
