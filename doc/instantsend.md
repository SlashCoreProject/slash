...
This mechanism has been integrated into Bitcore-Node-Slash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/slashcoreproject/insight-api-slash#web-socket-api](https://github.com/slashcoreproject/insight-api-slash#web-socket-api)
* API: [https://github.com/slashcoreproject/insight-api-slash#instantsend-transactions](https://github.com/slashcoreproject/insight-api-slash#instantsend-transactions)
...
By default, the Slash Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Slash Core daemon:
