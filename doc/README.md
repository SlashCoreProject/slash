...
This is the official reference wallet for Slash digital currency and comprises the backbone of the Slash peer-to-peer network. You can [download Slash Core](https://www.slash.org/downloads/) or [build it yourself](#building) using the guides below.
