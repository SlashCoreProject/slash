...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Slash related functionality
...
/*
    ...
    allow endless transaction that would bloat Slash and make it unusable. To
