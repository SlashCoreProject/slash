    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Slash Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Slash Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  slash-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Slash in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SLASH, 0.1 SLASH, 1 SLASH and 10 SLASH -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://slashcoreproject.atlassian.net/wiki/display/DOC/PrivateSend\">https://slashcoreproject.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Slash Core is shutting down...") + "<br /><br />" +
