    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Slash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Slash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and slash: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Slash Core"), this);
    aboutAction->setStatusTip(tr("Show information about Slash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Slash Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Slash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Slash addresses"));
    ...
    openAction->setStatusTip(tr("Open a slash: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Slash Core help message to get a list with possible Slash Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Slash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Slash network", "", count));
    } else {
...
{
    QString strTitle = tr("Slash Core"); // default title
