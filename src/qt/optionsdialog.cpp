    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SLASH-light"), QVariant("light"));
    ui->theme->addItem(QString("SLASH-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("SLASH-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SLASH-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SLASH-traditional"), QVariant("trad"));
