...
#define BOOST_TEST_MODULE Slash Test Suite

#include "test_slash.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_slash_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
