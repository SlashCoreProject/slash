...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SlashNetwork") type = SlashNetwork;
    if(strType == "SlashNetworkVariable") type = SlashNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SlashNetwork) s = "SlashNetwork";
    if(type == SlashNetworkVariable) s = "SlashNetworkVariable";
